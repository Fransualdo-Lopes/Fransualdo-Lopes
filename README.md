...
<h3 align="center">ISP Automation Engineer | DevOps | Linux Infrastructure Specialist</h3>
...
<p align="center">
  Network Automation • DNS Engineering • Huawei OLT • DevOps Mindset
</p>
...
Network & ISP Automation Engineer with strong experience in:

- Production Linux environments
- DNS Engineering (RPZ / Bind9)
- Huawei OLT / ONT automation
- Operational process optimization
- Infrastructure reliability

I specialize in transforming manual ISP operations into scalable automation systems.

> Focused on performance, reliability and operational efficiency.
...
- 🌐 DNS automation with RPZ in real ISP environment
- 📡 Huawei OLT integration & ONT mass configuration
- ⚙ Automation reducing repetitive operational workload
- 📈 Continuous improvement mindset applied to telecom operations
...
Stack: `Linux` · `Bind9` · `Shell Script`

---

## 🟢 Huawei ONT Massive Configuration Automation

Automated deployment of `changeNCEURL.xml` to ONTs.

✔ NCE Home-Insight integration  
✔ Automated FTP workflow  
...
Web interface for OLT automation & management.
...
### Development
`Shell` · `Python` · `Java` · `C++` · `React` · `JavaScript`
...
<p align="center">
  <img height="165em" src="https://github-readme-stats.vercel.app/api?username=Fransualdo-Lopes&show_icons=true&theme=tokyonight&hide_border=true"/>
  <img height="165em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Fransualdo-Lopes&layout=compact&theme=tokyonight&hide_border=true"/>
</p>
